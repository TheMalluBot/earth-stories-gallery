    ...
    <section id="about" className="py-20">
      <div className="container px-4">
          ...
          <div className="order-1 lg:order-2 grid grid-cols-2 gap-4 about-image-grid">
            <div className="space-y-4">
              <img 
                ...
                className="rounded-lg w-full object-cover h-48 md:h-64 about-image"
              />
              <img 
                src="https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                alt="Landscape photography" 
                className="rounded-lg w-full object-cover h-64 md:h-80 about-image"
              />
            </div>
        ...
        <div className="text-center mb-10">
          <h3 className="text-2xl font-serif font-bold mb-4 section-heading">Behind the Scenes</h3>
